        ...
        <Container>
          <div className="mb-10 space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="mx-auto mt-3 h-1.5 w-20 sm:w-24 rounded-full bg-gradient-to-r from-primary to-accent" />
              <p className="mx-auto mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base md:text-lg opacity-80">
                Build job‑ready skills with curated, practical courses across modern technologies.
              </p>
              <div className="mt-3 sm:mt-4">
                <span className="badge badge-primary">{total} courses available</span>
              </div>
            </div>
            ...
            <div className="mt-2 flex items-center justify-center gap-3">
              ...
              <div className="w-full max-w-full overflow-x-auto py-1">
                <div className="inline-flex rounded-full border border-white/10 bg-base-200/60 p-1 shadow-lg shadow-black/10 whitespace-nowrap">
                  <div className="join">
                    <Link
                      className={`btn btn-sm join-item rounded-full px-4 sm:px-5 ${
